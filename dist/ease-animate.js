...
/***/ (function(module, exports, __webpack_require__) {
	...
	function domAnimate(opts) {
	  ...
	  var easing = opts.easing || 'quadInOut';
	  var animationProps = getAnimationProps(selector, _opts, duration, easing, this.interval);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function scrollAnimate(opts) {
	  ...
	  var numbers = generateNumber(document.body.scrollTop || document.documentElement.scrollTop, opts.targetValue, opts.duration || 500, opts.easing || 'circleInOut', interval);
